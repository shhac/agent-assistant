    ...
    <>
      <fieldset className="config-field-group">
        ...
        <p className="field-hint" id="worker-usage-hint">
          ...
          and resuming work and every request a running worker makes. Work
          continues on its own once usage is below the limit. Set 0 to disable
          an engine’s limit.
        </p>
        ...
        <p className="field-hint" id="worker-usage-unavailable-hint">
          ...
          usage is re-read about once a minute, so work already admitted or in
          flight can carry usage a little past the limit.
        </p>
      </fieldset>
      ...
      <fieldset className="config-field-group">
        ...
        <p className="field-hint" id="worker-token-budget-hint">
          ...
          and resumes — reach this number. The check happens before each
          request, so the last one can finish past the limit. Raise the number
          and resume to continue with the saved work. If a provider reports no
          usage for a call, that consumption cannot be established: the
          assignment waits rather than treating it as free, and only setting
          this to 0 continues it. This counts tokens, not money, and no price is
          estimated.
        </p>
      </fieldset>
    </>
