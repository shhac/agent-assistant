...
func TestClaudeModelCatalogReadsOnlyInitializationMetadata(t *testing.T) {
	fixture := `{"type":"control_response","response":{"subtype":"success","request_id":"agent-assistant-models","response":{"account":{"token":"not-for-ui"},"commands":["unrelated"],"models":[{"value":"opus","displayName":"Opus","resolvedModel":"version-is-cli-owned","description":"Careful reasoning","supportedEffortLevels":["low","high"]},{"value":"haiku","displayName":"Haiku"}]}}}`
